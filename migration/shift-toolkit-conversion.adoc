...
* link:shift-toolkit-convert-esx2hyperv.html[VMware ESX to Microsoft Hyper-V: virtual machine disk (VMDK) to virtual hard disk format (VHDX)]
* link:shift-toolkit-convert-esx2qcow2.html[VMware ESX to KVM compatible hypervisors (VMDK to QCOW2)]
* link:shift-toolkit-convert-hyperv2esx.html[Microsoft Hyper-V to VMware ESX (VHDX to VMDK)]
* link:shift-toolkit-convert-esx2kvm.html[VMware ESX to KVM (VMDK to RAW)]
