...
Shift toolkit can be run on Windows OS 2019, 2022 and 2025 version. 
...
NOTE: In the current release, end to end virtual machine migration is supported with Hyper-V, Openshift, VMware and Oracle Virtualization. 
