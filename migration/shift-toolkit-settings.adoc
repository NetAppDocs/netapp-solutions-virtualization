...
image::shift-toolkit-471.png["Verify Migration job details"]

image::shift-toolkit-472.png["Verify Migration job list"]
...
image::shift-toolkit-473.png["Split Workflow strategy selection"]

image::shift-toolkit-474.png["Split Workflow job progress"]
...
image::shift-toolkit-475.png["Advanced Hypervisor Settings overview"]

image::shift-toolkit-476.png["Advanced Hypervisor Settings options"]

image::shift-toolkit-477.png["Advanced Hypervisor Settings configuration"]

image::shift-toolkit-478.png["Advanced Hypervisor Settings job details"]