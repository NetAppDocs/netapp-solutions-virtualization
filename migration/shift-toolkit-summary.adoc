...
summary: 
---
= Next steps after converting or migrating VMs using the Shift Toolkit
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
image:shift-toolkit-086.png["Figure showing input/output dialog or representing written content"]
