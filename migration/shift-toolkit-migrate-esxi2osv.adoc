...
* For invoke-vmscript for preparing the VM, use local administrator for Windows OS and for Linux distributions, use a user who has permissions to execute commands without password prompt.
...
The following video demonstrates the process outlined in this article.
