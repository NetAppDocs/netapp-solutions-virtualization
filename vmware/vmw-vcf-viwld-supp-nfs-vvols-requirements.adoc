...
summary: "To deploy NFS vVols in a VMware Cloud Foundation workload domain, you need a fully configured ONTAP AFF or ASA storage system, a completed VCF management domain, and an existing VI workload domain. Review the recommended network design and infrastructure requirements to ensure reliable, high-performance storage integration."
---
= Deployment requirements for adding NFS vVols in a workload domain
...
[.lead]
Review the recommended network design and infrastructure requirements to deploy NFS vVols in a VMware Cloud Foundation workload domain. You need a fully configured ONTAP AFF or ASA storage system, a completed VCF management domain, and an existing workload domain. 
...
* A workload domain has been previously deployed.
...
== What's next?
After reviewing the requirements, link:vmw-vcf-viwld-supp-nfs-vvols-svm-lifs.html[create the SVM and LIFs].
