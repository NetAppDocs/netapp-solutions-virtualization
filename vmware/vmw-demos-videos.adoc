...
[.lead]
Watch videos and demos that explain important features of hybrid cloud, virtualization, and container solutions. See how to use NetApp ONTAP tools for VMware vSphere, the SnapCenter Plug-in for VMware vSphere, 3-2-1 data protection, and how NetApp works with AWS and Azure. Get helpful tips for setting up and managing these technologies.
...
[%collapsible%open]
====
3-2-1 data protection solutions combine on-premises primary and secondary backups, using SnapMirror technology, with replicated copies to object storage using NetApp Backup and Recovery.
...
// NetApp Solutions restructuring (jul 2025) - renamed from vmware/vsphere_demos_videos.adoc
