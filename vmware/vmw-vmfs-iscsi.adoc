...
. link:++https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere/8-0/vsphere-networking/basic-networking-with-vnetwork-distributed-switches/dvport-groups.html++[Verify that iSCSI portgroups are available].
...
// NetApp Solutions restructuring (jul 2025) - renamed from vmware/vsphere_ontap_auto_block_iscsi.adoc
