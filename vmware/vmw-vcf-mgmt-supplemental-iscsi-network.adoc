...
== What's next?
After you configure networking for iSCSI on all ESXi hosts in the workload domain, link:vmw-vcf-mgmt-supplemental-iscsi-storage.html[configure storage for iSCSI on ESXi hosts].