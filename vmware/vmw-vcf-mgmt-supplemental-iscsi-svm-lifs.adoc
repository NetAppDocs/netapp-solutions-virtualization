...
summary: "Create a Storage Virtual Machine (SVM) with multiple Logical Interfaces (LIFs) to provide iSCSI connectivity for VMware Cloud Foundation management domains. This procedure involves configuring the SVM with iSCSI protocol support and setting up multiple LIFs across separate Ethernet networks to enable multipathing and failover for optimal performance and availability."
---
...
== What's next?
After you create the SVM and LIFs, you link:vmw-vcf-mgmt-supplemental-iscsi-network.html[configure networking for iSCSI on ESXi hosts].
