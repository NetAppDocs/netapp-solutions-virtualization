...
summary: "Configure iSCSI vVols storage in a workload domain using ONTAP tools. You'll deploy ONTAP tools for VMware vSphere, register a storage system, create a storage capability profile, and provision a vVols datastore in the vSphere client."
---
...
[.lead]
Configure iSCSI vVols storage in a workload domain using ONTAP tools. You'll deploy ONTAP tools for VMware vSphere, register a storage system, create a storage capability profile, and provision a vVols datastore in the vSphere client.
