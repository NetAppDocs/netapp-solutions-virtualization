...
. Alternately, NFS volumes can be created in the ONTAP CLI. For more information refer to the link:https://docs.netapp.com/us-en/ontap-cli/volume-create.html[volume create] command in the ONTAP commands documentation.
====
