...
For additional information on using VMFS iSCSI datastores with VMware, refer to link:vmw-vmfs-iscsi.html[vSphere VMFS Datastore - iSCSI Storage backend with ONTAP].
