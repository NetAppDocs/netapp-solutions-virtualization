...
summary: Convert vSphere cluster to VCF management domain using the VCF Import Tool.
---
...
[.lead]
Convert an existing vSphere 8 cluster to a VCF 5.2 management domain using the VCF Import Tool. This procedure includes validating the vCenter appliance, deploying the SDDC manager, creating NSX deployment specifications, and performing the conversion.
