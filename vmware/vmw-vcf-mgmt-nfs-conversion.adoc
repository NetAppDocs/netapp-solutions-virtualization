...
+
image:../media/vmware-vcf-import-nfs-011.png[vcf import tool precheck]
...
Review a printout of VCF import tool functions by running the following command from the `/home/vcf/vcf-import-package/vcf-brownfield-import-<version>/vcf-brownfield-toolset` directory.
