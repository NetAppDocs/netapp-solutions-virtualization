...
summary: "To deploy iSCSI vVols in a VMware Cloud Foundation workload domain, you need a fully configured ONTAP AFF or ASA storage system, a completed VCF management domain, and an existing workload domain. Review the recommended network design and infrastructure requirements to ensure reliable, high-performance storage integration."
---
== Deployment requirements for iSCSI vVols in a workload domain
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
Review the recommended network design and infrastructure requirements to deploy iSCSI vVols in a VMware Cloud Foundation workload domain. You need a fully configured ONTAP AFF or ASA storage system, a completed VCF management domain, and an existing workload domain.
