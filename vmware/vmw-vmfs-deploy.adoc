...
image:vmfs-deploy-001.png["Figure showing input/output dialog or representing written content"]
...
image:vmfs-deploy-002.png["Figure showing input/output dialog or representing written content"]

image:vmfs-deploy-003.png["Figure showing input/output dialog or representing written content"]
...
+
image:vmfs-deploy-004.png["Figure showing input/output dialog or representing written content"]
...
+
image:vmfs-deploy-005.png["Figure showing input/output dialog or representing written content"]
+
image:vmfs-deploy-006.png["Figure showing input/output dialog or representing written content"]
+
image:vmfs-deploy-007.png["Figure showing input/output dialog or representing written content"]

After successful installation, the web console shows the state of ONTAP tools for VMware vSphere. 

image:vmfs-deploy-008.png["Figure showing input/output dialog or representing written content"]

image:vmfs-deploy-009.png["Figure showing input/output dialog or representing written content"]
...
+
image:vmfs-deploy-010.png["Figure showing input/output dialog or representing written content"]

. In the Type pane, select VMFS in Datastore Type.
+
image:vmfs-deploy-011.png["Figure showing input/output dialog or representing written content"]
...
+
image:vmfs-deploy-012.png["Figure showing input/output dialog or representing written content"]
...
+
image:vmfs-deploy-013.png["Figure showing input/output dialog or representing written content"]
...
+
image:vmfs-deploy-014.png["Figure showing input/output dialog or representing written content"]
...
+
image:vmfs-deploy-015.png["Figure showing input/output dialog or representing written content"]
...
image:vmfs-deploy-016.png["Figure showing input/output dialog or representing written content"]
...
image:vmfs-deploy-017.png["Figure showing input/output dialog or representing written content"]
...
image:vmfs-deploy-018.png["Figure showing input/output dialog or representing written content"]
...
image:vmfs-deploy-019.png["Figure showing input/output dialog or representing written content"]
...
+
image:vmfs-deploy-020.png["Figure showing input/output dialog or representing written content"]

. To access the plug-in, navigation to the left sidecar of the vCenter web client page, select SnapCenter Plug-in for VMware.
+
image:vmfs-deploy-021.png["Figure showing input/output dialog or representing written content"]
...
+
image:vmfs-deploy-022.png["Figure showing input/output dialog or representing written content"]
+
image:vmfs-deploy-023.png["Figure showing input/output dialog or representing written content"]
...
+
image:vmfs-deploy-024.png["Figure showing input/output dialog or representing written content"]
...
+
image:vmfs-deploy-025.png["Figure showing input/output dialog or representing written content"]
+
...
+
image:vmfs-deploy-026.png["Figure showing input/output dialog or representing written content"]

. On the Resources page, select the scope (virtual machines or datastores) and the datacenter.
+
image:vmfs-deploy-027.png["Figure showing input/output dialog or representing written content"]
...
+
image:vmfs-deploy-028.png["Figure showing input/output dialog or representing written content"]
...
+
image:vmfs-deploy-029.png["Figure showing input/output dialog or representing written content"]
...
+
image:vmfs-deploy-030.png["Figure showing input/output dialog or representing written content"]
...
+
image:vmfs-deploy-031.png["Figure showing input/output dialog or representing written content"]
+
...
+
image:vmfs-deploy-032.png["Figure showing input/output dialog or representing written content"]

. Select the VM that needs to be restored from the backup.
+
image:vmfs-deploy-033.png["Figure showing input/output dialog or representing written content"]
...
+
image:vmfs-deploy-034.png["Figure showing input/output dialog or representing written content"]

. On the Select Location page, select the location for the primary location.
+
image:vmfs-deploy-035.png["Figure showing input/output dialog or representing written content"]

. Review the Summary page and then select Finish.
+
image:vmfs-deploy-036.png["Figure showing input/output dialog or representing written content"]
+
...
image:vmfs-deploy-037.png["Figure showing input/output dialog or representing written content"]
...
image:vmfs-deploy-038.png["Figure showing input/output dialog or representing written content"]
...
image:vmfs-deploy-039.png["Figure showing input/output dialog or representing written content"]
...
* View detailed guidance for link:https://docs.netapp.com/us-en/netapp-solutions-cloud/vmware/vmw-aws-vmc-migrate-hcx.html[Migrate Workloads to FSx ONTAP datastore^].
* View detailed guidance for link:https://docs.netapp.com/us-en/netapp-solutions-cloud/vmware/vmw-azure-avs-migrate-hcx.html[Migrate workloads to Azure NetApp Files datastore^].
* View detailed guidance for link:https://docs.netapp.com/us-en/netapp-solutions-cloud/vmware/vmw-gcp-gcve-migrate-hcx.html[Migrate workloads to Google Cloud NetApp Volumes datastore^].

== Disaster Recovery

=== Disaster Recovery between on-premises sites

For more details, please visit link:https://docs.netapp.com/us-en/netapp-solutions-cloud/vmware/vmw-hybrid-dr-vmfs.html[DR using NetApp Disaster Recovery for VMFS Datastores^]
...
* View detailed guidance for link:https://docs.netapp.com/us-en/netapp-solutions-cloud/vmware/vmw-aws-fsxn-vmc-ds-dr-veeam.html[Disaster Recovery to FSx ONTAP datastore^].
* View detailed guidance for link:https://docs.netapp.com/us-en/netapp-solutions-cloud/vmware/vmw-azure-avs-dr-jetstream.html[Disaster Recovery to Azure NetApp Files datastore^].
* View detailed guidance for link:https://docs.netapp.com/us-en/netapp-solutions-cloud/vmware/vmw-gcp-gcve-app-dr-ds-veeam.html[Disaster Recovery to Google Cloud NetApp Volumes datastore^].
...
// NetApp Solutions restructuring (jul 2025) - renamed from vmware/vmfs-deployment.adoc
