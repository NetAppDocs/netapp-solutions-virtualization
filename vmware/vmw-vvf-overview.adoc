...
image:vmware-nfs-overview-001.png[VM Storage Options]
{nbsp}
...
image:vmware-nfs-overview-002.png[AFF Arrays]
{nbsp}
...
image:vmware-nfs-overview-003.png[C-Series Arrays]
...
View the ONTAP tools 10 deployment solution at link:vmw-nfs-otv10.html[Use ONTAP tools 10 to configure NFS datastores for vSphere 8]
...
For more information on backup strategies with NetApp Backup and Recovery visit link:https://docs.netapp.com/us-en/data-services-backup-recovery/index.html[NetApp Backup and Recovery Documentation^].

For step-by-step deployment instructions for the SnapCenter Plug-in, refer to the solution link:vmw-vcf-scv-viwld.html[Use SnapCenter Plug-in for VMware vSphere to protect VMs on VCF Workload Domains].
...
For detailed information on nConnect, refer to link:vmw-vsphere8-nfs-nconnect.html[NFS nConnect Feature with VMware and NetApp].
...
See the the full solution at the NetApps Solutions documentation center: link:vmw-nfs-arp.html[Autonomous Ransomware Protection for NFS Storage]
...
See the the full solution at the NetApps Solutions documentation center: link:vmw-nfs-vlsr.html[Autonomous Ransomware Protection for NFS Storage]
...
See the the full solution at the NetApps Solutions documentation center: link:https://docs.netapp.com/us-en/netapp-solutions-cloud/vmware/vmw-hybrid-dr-nfs.html[DR using NetApp Disaster Recovery NFS Datastores^]

=== Solutions Overview
Solutions covered in this documentation:

* *NFS nConnect feature with NetApp and VMware*. Click link:vmw-vsphere8-nfs-nconnect.html[*here*] for deployment steps. 
• *Use ONTAP tools 10 to configure NFS datastores for vSphere 8*. Click link:vmw-nfs-otv10.html[*here*] for deployment steps.
• *Deploy and use the SnapCenter Plug-in for VMware vSphere to protect and restore VMs*. Click link:vmw-vcf-scv-viwld.html[*here*] for deployment steps.
• *Disaster recovery of NFS Datastores with VMware Site Recovery Manager*. Click link:vmw-nfs-vlsr.html[*here*] for deployment steps.
• *Autonomous Ransomware Protection for NFS storage*. Click link:https://docs.netapp.com/us-en/netapp-solutions-cloud/vmware/vmw-hybrid-dr-nfs.html[*here*^] for deployment steps.


// NetApp Solutions restructuring (jul 2025) - renamed from vmware/vmware_nfs_overview.adoc
