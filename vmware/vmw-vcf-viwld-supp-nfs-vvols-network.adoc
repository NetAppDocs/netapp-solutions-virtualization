...
== What's next?
After you configure networking for NFS on all ESXi hosts in the workload domain, you link:vmw-vcf-viwld-supp-nfs-vvols-storage.html[configure storage for NFS vVols].