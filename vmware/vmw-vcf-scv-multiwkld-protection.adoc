...
image:vmware-vcf-aff-051.png[VCF one management domain and two workload domains]
...
image:vmware-vcf-aff-063.png[one to one between VCF domain and SCV]
...
image:vmware-vcf-aff-052.png[Deploy SCV OVF Template]
+
{nbsp}
+
...
image:vmware-vcf-aff-053.png[MFA for SnapCenter management Web Interface login]
+
{nbsp}
+
...
+
image:vmware-vcf-aff-054.png[NetApp SnapCenter for VMware vSphere Web COnfiguration]
====
...
image:vmware-vcf-aff-055.png[Getting started with SCV]
...
+
image:vmware-vcf-aff-056.png[Create Backup Policy]
...
image:vmware-vcf-aff-057.png[Create Resource Group]
====
...
image:vmware-vcf-aff-062.png[Datastore Restore]
...
+
image:vmware-vcf-aff-061.png[Files and Folder Restore]
...
// NetApp Solutions restructuring (jul 2025) - renamed from vmware/vmw-vcf-scv-multiwkld.adoc
