...
== What's next?
After you configure networking for iSCSI on all ESXi hosts in the workload domain, you link:vmw-vcf-viwld-supp-iscsi-vvols-storage.html[configure storage for iSCSI vVols].