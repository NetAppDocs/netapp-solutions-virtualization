...
---
= Implementing Disaster Recovery with NetApp NetApp Disaster Recovery
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
Before the configuring disaster recovery plan, ensure the following link:https://docs.netapp.com/us-en/data-services-disaster-recovery/get-started/dr-prerequisites.html[pre-requisites] are met:
