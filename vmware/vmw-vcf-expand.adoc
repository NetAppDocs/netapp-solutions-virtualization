...
You can use the following protocols to expand storage in VCF management domains and VI workload domains. Choose the best option for your environment and seamlessly integrate supplemental storage into your VCF deployment.
...
== Supported solutions for adding supplemental storage 
Refer to the following solutions for the technical details to add supplemental storage on VCF management domains and Virtual Infrastructure (VI) workload domains.
