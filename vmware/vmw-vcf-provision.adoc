...
[.lead]
NetApp ONTAP storage is an ideal primary storage solution for VMware Cloud Foundation (VCF) management and workload domains. ONTAP delivers high performance, scalability, advanced data management, and seamless integration to improve operational efficiency and data protection.
...
* link:vmw-vcf-viwld-principal-fc.html[Workload Domain with FC]

* link:vmw-vcf-viwld-principal-nfs.html[Workload Domain with NFS]
