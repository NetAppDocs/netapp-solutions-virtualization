...
This section shows how to set up an AppVault object in Trident Protect using ONTAP S3 object storage.

Use oc commands and the yaml files shown below to create a secret and the ApVault custom resource for ONTAP s3. Ensure that you create them in the trident protect namespace. 
