...
For complete details on Trident, refer to NetApp Trident [documentation here](https://docs.netapp.com/us-en/trident/).
...
For complete details on Trident Protect, refer to NetApp Trident Protect [documentation here](https://docs.netapp.com/us-en/trident/trident-protect/learn-about-trident-protect.html).

== NetApp ONTAP hardware models and Trident drivers
