...
For complete details on OpenShift Container platform, refer to the Red Hat [documentation here.](https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/overview/ocp-overview)

For complete details on OpenShift Virtualization, refer to the Red Hat [documentation here.](https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/virtualization/index)