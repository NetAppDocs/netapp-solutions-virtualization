...
Download the Velero CLI from link:https://velero.io/docs/v1.3.0/basic-install/#install-the-cli[Velero documentation]. 

NOTE: This above link points to the Velero CLI version used while testing.
