...
You must have a VolumeSnapshotClass created that can then be used to create a VolumeSnapshot. This would have been created as part of the prerequisites for installing OpenShift Virtualization. You can refer to the link:osv-trident-install.html[Step 3 to create a VolumeSnapshotClass configuration] for details.
