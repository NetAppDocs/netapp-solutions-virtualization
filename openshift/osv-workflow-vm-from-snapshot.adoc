...
// NetApp Solutions restructuring (jul 2025) - renamed from containers/rh-os-n_use_case_openshift_virtualization_workflow_vm_from_snapshot.adoc THIS FILE CAN BE DELETED AFTER REVIEWING THE CHANGES IN osv-vm-deployment-other-methods.adoc