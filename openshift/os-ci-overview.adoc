...
To start using Data Infrastructure Insights, you can sign up at the following link:https://www.netapp.com/forms/dii-free-trial/[Data Infrastructure Insights Free Trial]. For details, refer to the link:https://docs.netapp.com/us-en/cloudinsights/task_cloud_insights_onboarding_1.html[Data Infrastructure Insights Onboarding]
