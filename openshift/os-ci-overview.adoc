...
To start using Cloud Insights, you must sign up on the link:https://www.netapp.com/console[NetApp Console]. For details, refer to the link:https://docs.netapp.com/us-en/cloudinsights/task_cloud_insights_onboarding_1.html[Cloud Insights Onboarding]
