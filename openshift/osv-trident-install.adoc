...
----
+
For sample YAML files to create Trident objects for FSxN storage on ROSA clusters and a VolumeSnapshotClass, see the sections later in this page.
...
[source,bash]
----
oc create -f tbc-fsx-iscsi.yaml
...
[source]
----
storageclass.kubernetes.io/is-default-class -> set it to true
----
+
From the CLI:
+
...
[source]
----
storageclass.kubevirt.io/is-default-virt-class -> set it to true
----
+
From the CLI:
+
...
[source]
----
snapshot.storage.kubernetes.io/is-default-class -> set it to true
----
+
From the CLI:
+
