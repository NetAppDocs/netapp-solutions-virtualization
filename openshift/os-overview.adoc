...
. Follow the link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.22#Install[installation instructions] provided by Red Hat to deploy to your environment of choice.
