...
+
. Nereate local sync jobs to ONTAP S3 storage
...
. In the Proxmox VE web interface, navigate to Datacenter -> Storage aApp Console can be utilized for management and data services.

== Add Proxmox Backup Server to Proxmox VE c
