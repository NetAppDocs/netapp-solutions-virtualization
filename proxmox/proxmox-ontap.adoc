...
. Create the LUN with desired size on the SVM and present to igroup created in above step. Ensure Anti-Ransomware protection is enabled on the volume security tab.
+
