...
summary: "Configure SMB/CIFS storage for Proxmox Virtual Environment using ONTAP. This procedure includes SVM enablement, LIF creation, Active Directory configuration, volume creation, and multichannel setup for fault tolerance and enhanced performance."
---
...
NOTE: Passwords are saved in clear text files and are accessible only to the root user. Refer to link:https://pve.proxmox.com/pve-docs/chapter-pvesm.html#storage_cifs[Proxmox VE documentation].
...
[%collapsible]
====
image:proxmox-ontap-smb-001.png[nas interface details]
====
...
[%collapsible]
====
image:proxmox-ontap-smb-002.png[Join domain info]
====
...
[%collapsible]
====
image:proxmox-ontap-smb-004.png[SMB share info]
====
...
. Using the Management UI at `https:<proxmox-node>:8006`, click Datacenter, select Storage, click Add, and select SMB/CIFS.
+
.Show example
[%collapsible]
====
image:proxmox-ontap-smb-005.png[SMB storage navigation]
====
...
[%collapsible]
====
image:proxmox-ontap-smb-006.png[SMB storage addition]
====
...
[%collapsible]
====
image:proxmox-ontap-smb-007.png[multichannel setup]
====
...
[%collapsible]
====
image:proxmox-ontap-smb-008.png[storage configuration file for SMB]
====
