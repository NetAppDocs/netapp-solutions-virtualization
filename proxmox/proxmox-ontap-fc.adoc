...
----
+
NOTE: The desired configuration for ONTAP devices multipath is already included in package. For more information, refer to the link:https://docs.netapp.com/us-en/ontap-sanhost/hu-proxmox-ve-9x.html#step-1-confirm-the-multipath-configuration-for-your-host[ONTAP 9 documentation on Proxmox VE 9.x for FCP and iSCSI with ONTAP storage] 
