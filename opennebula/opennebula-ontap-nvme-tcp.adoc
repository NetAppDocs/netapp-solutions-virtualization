...
keywords: netapp, opennebula, opennebula ve, nvme, nvme-tcp, lvm, ontap, storage
summary: "Configure Logical Volume Manager (LVM) with NVMe over TCP for OpenNebula Virtual Environment using ONTAP. This procedure includes nvme-cli installation, discovery configuration, namespace provisioning, subsystem setup, and volume group creation for shared storage."
---
= Configure LVM Thin with NVMe/TCP for OpenNebula
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
