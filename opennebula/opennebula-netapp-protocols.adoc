...
NOTE: If need assistance with E-Series or EF-Series storage protocols, check the link https://docs.netapp.com/us-en/e-series/config-linux/index.html[NetApp E-Series and EF-Series documentation for setting up LVM on Linux environments] along with one of the LVM Thin documentation for reference. 
