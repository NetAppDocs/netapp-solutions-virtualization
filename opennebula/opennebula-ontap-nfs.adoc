...
keywords: netapp, opennebula, opennebula ve, nfs, ontap, storage, nconnect, session trunking
summary: "Configure NFS storage for OpenNebula Virtual Environment using ONTAP. This procedure includes SVM enablement, LIF creation, export policy configuration, volume creation, and nConnect or session trunking setup for fault tolerance and performance."
---
