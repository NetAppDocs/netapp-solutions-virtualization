...
keywords: netapp, opennebula, opennebula ve, nvme, nvme-fc, lvm, ontap, storage
summary: "Configure Logical Volume Manager (LVM) with NVMe over Fibre Channel for OpenNebula Virtual Environment using ONTAP. This procedure includes nvme-cli installation, namespace provisioning, subsystem setup, and volume group creation for shared storage."
---
= Configure LVM Thin with NVMe/FC for OpenNebula
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[%collapsible]
====
image:proxmox-ontap-nvme-fc-001.png[nvme namespace creation]
====
...
[%collapsible]
====
image:proxmox-ontap-nvme-fc-003.png[lvm storage navigation]
====
...
[%collapsible]
====
image:proxmox-ontap-nvme-fc-004.png[lvm on existing vg]
====
...
[%collapsible]
====
image:proxmox-ontap-nvme-fc-005.png[lvm on nvme fc configuration]
====
