...
keywords: netapp, opennebula, opennebula ve, fc, fibre channel, lvm, ontap, storage
summary: "Configure Logical Volume Manager (LVM) with Fibre Channel for OpenNebula Virtual Environment using ONTAP. This procedure includes multipath configuration, LUN provisioning, igroup setup, and volume group creation for shared storage."
---
= Configure LVM Thin with FC for OpenNebula
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
+
image:proxmox-ontap-fc-001.png[FC interface details]
...
+
image:proxmox-ontap-fc-002.png[lun details]
...
[%collapsible]
====
image:proxmox-ontap-fc-003.png[lvm storage navigation]
====
...
[%collapsible]
====
image:proxmox-ontap-fc-004.png[lvm storage creation]
====
...
[%collapsible]
====
image:proxmox-ontap-fc-005.png[lvm fc configuration]
====
+
